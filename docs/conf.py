# -*- coding: utf-8 -*-
#
# DAG1 documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'DAG1.tex', u'DAG1 Documentation',
...
man_pages = [
    (master_doc, 'dag1', u'DAG1 Documentation',
     [author], 1)
]
