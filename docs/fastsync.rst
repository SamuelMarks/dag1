...
FastSync is an element of the DAG1 protocol which enables nodes to catch up
...
The DAG1 node is implemented as a state machine where the possible states are:
